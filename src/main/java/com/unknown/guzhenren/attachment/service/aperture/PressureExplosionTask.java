...
public final class PressureExplosionTask {

    private PressureExplosionTask(@NotNull ServerLevel level, double x, double y, double z, int radius,
    ...
    private static final List<PressureExplosionTask> ACTIVE = new ArrayList<>();
    ...
    public static void start(@NotNull ServerLevel level, double x, double y, double z, int radius,
                             @NotNull ExtremePhysique physique) {
        ACTIVE.add(new PressureExplosionTask(level, x, y, z, radius, physique));
    }

    public static void tickAll() {
        Iterator<PressureExplosionTask> it = ACTIVE.iterator();
        while (it.hasNext()) {
