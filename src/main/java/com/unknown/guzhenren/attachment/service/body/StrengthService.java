...
public final class StrengthService {
    ...
    public static @NotNull StrengthData get(@NotNull Player p) {return p.getData(ModAttachments.STRENGTH);}
    ...
    public static void clear(@NotNull ServerPlayer p) {store(p, StrengthData.DEFAULT);}
