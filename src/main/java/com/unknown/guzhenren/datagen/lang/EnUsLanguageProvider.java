...
public class EnUsLanguageProvider extends LanguageProvider {
    ...
    private void addScreenKeys() {
        ...
        add("guzhenren.menu.refinement.essence",     "Refining this Gu needs %s essence");
        add("guzhenren.menu.refinement.craft",       "Refine");
        add("guzhenren.menu.refinement.room",        "No room left in the output");
        add("guzhenren.menu.refinement.awakened",    "Refining Gu needs an open aperture");
        ...
        add("guzhenren.menu.refinement.gap",         "Window %s/%s done  ·  settling");
        add("guzhenren.menu.refinement.lost_stones", "Not enough Primeval Stone — the refinement failed");
