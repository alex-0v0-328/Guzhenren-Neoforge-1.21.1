...
public class EnUsLanguageProvider extends LanguageProvider {
    ...
    private void addDisplayKeys() {
        ...
        add("guzhenren.hud.withdrawing",                 "Withdrawing  %s / %s");
    }
    //endregion
    ...
    private void addItemKeys() {
        ...
        add("item.guzhenren.primeval_elder_gu_1",          "Primeval Elder Gu I");
        add("item.guzhenren.primeval_elder_gu_2",          "Primeval Elder Gu II");
        add("item.guzhenren.primeval_elder_gu_3",          "Primeval Elder Gu III");
        add("item.guzhenren.primeval_elder_gu_4",          "Primeval Elder Gu IV");
        add("item.guzhenren.primeval_elder_gu_5",          "Primeval Elder Gu V");
        add("item.guzhenren.primeval_stone",               "Primeval Stone");
        add("item.guzhenren.liquor",                       "Liquor");

        add("item.guzhenren.sword_qi_1",                   "Sword Qi I");
        add("item.guzhenren.sword_qi_2",                   "Sword Qi II");
        add("item.guzhenren.sword_qi_3",                   "Sword Qi III");
        add("item.guzhenren.sword_qi_4",                   "Sword Qi IV");
        add("item.guzhenren.sword_qi_5",                   "Sword Qi V");
        add("item.guzhenren.strength_qi_1",                "Strength Qi I");
        add("item.guzhenren.strength_qi_2",                "Strength Qi II");
        add("item.guzhenren.strength_qi_3",                "Strength Qi III");
        add("item.guzhenren.strength_qi_4",                "Strength Qi IV");
        add("item.guzhenren.strength_qi_5",                "Strength Qi V");
        add("item.guzhenren.life_qi_1",                    "Life Qi I");
        add("item.guzhenren.life_qi_2",                    "Life Qi II");
        add("item.guzhenren.life_qi_3",                    "Life Qi III");
        add("item.guzhenren.life_qi_4",                    "Life Qi IV");
        add("item.guzhenren.life_qi_5",                    "Life Qi V");
        add("item.guzhenren.essence_qi_1",                 "Essence Qi I");
        add("item.guzhenren.essence_qi_2",                 "Essence Qi II");
        add("item.guzhenren.essence_qi_3",                 "Essence Qi III");
        add("item.guzhenren.essence_qi_4",                 "Essence Qi IV");
        add("item.guzhenren.essence_qi_5",                 "Essence Qi V");
        add("item.guzhenren.death_qi_5",                   "Death Qi V");
