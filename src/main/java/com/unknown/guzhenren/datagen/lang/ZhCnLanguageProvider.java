...
public class ZhCnLanguageProvider extends LanguageProvider {
    ...
    private void addDisplayKeys() {
        ...
        add("guzhenren.hud.withdrawing",                 "取出中  %s / %s");
    ...
    private void addItemKeys() {
        ...
        add("item.guzhenren.primeval_elder_gu_1",          "一转元老蛊");
        add("item.guzhenren.primeval_elder_gu_2",          "二转元老蛊");
        add("item.guzhenren.primeval_elder_gu_3",          "三转元老蛊");
        add("item.guzhenren.primeval_elder_gu_4",          "四转元老蛊");
        add("item.guzhenren.primeval_elder_gu_5",          "五转元老蛊");
        add("item.guzhenren.primeval_stone",               "元石");
        add("item.guzhenren.liquor",                       "酒");

        add("item.guzhenren.sword_qi_1",                   "一转剑气");
        add("item.guzhenren.sword_qi_2",                   "二转剑气");
        add("item.guzhenren.sword_qi_3",                   "三转剑气");
        add("item.guzhenren.sword_qi_4",                   "四转剑气");
        add("item.guzhenren.sword_qi_5",                   "五转剑气");
        add("item.guzhenren.strength_qi_1",                "一转力气");
        add("item.guzhenren.strength_qi_2",                "二转力气");
        add("item.guzhenren.strength_qi_3",                "三转力气");
        add("item.guzhenren.strength_qi_4",                "四转力气");
        add("item.guzhenren.strength_qi_5",                "五转力气");
        add("item.guzhenren.life_qi_1",                    "一转生气");
        add("item.guzhenren.life_qi_2",                    "二转生气");
        add("item.guzhenren.life_qi_3",                    "三转生气");
        add("item.guzhenren.life_qi_4",                    "四转生气");
        add("item.guzhenren.life_qi_5",                    "五转生气");
        add("item.guzhenren.essence_qi_1",                 "一转元气");
        add("item.guzhenren.essence_qi_2",                 "二转元气");
        add("item.guzhenren.essence_qi_3",                 "三转元气");
        add("item.guzhenren.essence_qi_4",                 "四转元气");
        add("item.guzhenren.essence_qi_5",                 "五转元气");
        add("item.guzhenren.death_qi_5",                   "五转死气");
