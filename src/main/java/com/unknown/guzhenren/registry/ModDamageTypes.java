...
//  Keys only. DamageType is a datapack registry -- the JSON behind these is written at runData by
//  datagen/damage.
public final class ModDamageTypes {
    ...
    //  Registry access off the entity, not entity.level(): a Level is AutoCloseable and every IDE
    //  would then nag about a resource we have no business closing. See CLAUDE.md "Gotcha".
