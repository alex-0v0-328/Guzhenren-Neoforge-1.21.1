 ...
 *
 * <p>Tag-key holder (not a DeferredRegister): {@code HOPE_GU_SPAWNS} and {@code BOAR_GU_SPAWNS} list
 * the land biomes wild Gu spawn in. They must NOT collapse to {@code #minecraft:is_overworld} -- that
